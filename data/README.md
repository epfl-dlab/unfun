...
Headlines of the most common chunk pattern NP VP NP PP NP (as determined by the OpenNLP maximum-entropy chunker).
...
Chunked versions of the satirical headlines from headlines_for_game.tsv (using the OpenNLP maximum-entropy chunker).

Tab-separated columns:

- headline text
- headline annotated with chunk tags (for description of tags, cf. https://web.archive.org/web/20190110101722/https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html)
...
- tag of the modified chunk (for description of tags, cf. https://web.archive.org/web/20190110101722/https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html)
